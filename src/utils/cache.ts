 ...
 * Simple File Cache
 *
 * This is the only way I can manage to cache our image data during dev so that it's not
 * read from S3 every time we hot-relead. We write a json file to disk with all our data
 * in it
 */
